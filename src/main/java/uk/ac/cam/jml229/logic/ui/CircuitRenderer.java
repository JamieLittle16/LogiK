...
public class CircuitRenderer {
  ...
  // --- Styling Constants ---
  // RESTORED: These are public because CircuitInteraction reads them for
  // hit-testing
  ...
  // Helper to determine active pin for highlighting
